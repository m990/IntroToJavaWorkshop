...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		int backgroundColor = maze.getRGB(15, 120);
	...
	private void scare() {
		System.out.println("Donald Trump has taken over the world!");
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("babyDonald.wav"));
